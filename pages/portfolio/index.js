...
export default function PortfolioPage({ projects: initialData }) {
  ...
  return (
    <PageLayout
      title='Projects | Philip Laxamana | Fullstack Software Engineer'
      description="Here are some project pieces that I'm proud to present."
    >
      <Header />
