        ...
        <div className='grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-4 lg:gap-x-16 md:mb-16'>
          ...
          <div className='space-y-4 text-lg'>
            ...
            <p>
              ...
              video? What if you could see drones racing from their point of
              view? Well that is what this page is all about, Drone Racing!
            </p>
            <p>
              This webpage experimented with column and grid-based layouts to
              give an interesting and unique feel to the design. This site was a
              great way for me to practice implementing different layouts and
              techniques.
            </p>
            {/* Badges */}
            <div className='pb-8'>
...
const Badge = ({ name, style }) => {
  return (
    <div
      className={`flex items-center justify-center py-1 px-4 rounded-lg ${style.background}`}
    >
