...
export default function BlogPage({ posts: initialData }) {
  ...
  return (
    <PageLayout
      title='Blog | Philip Laxamana | Fullstack Software Engineer'
      description='Welcome to a collection of my posts where I blog about life, coding and anything that excites me'
    >
      <Header />
        ...
        <div className='z-10 px-4 py-52'>
          <div className='container mx-auto'>
            ...
            <div className='grid justify-center gap-y-12 md:gap-x-16 md:grid-cols-2 xl:grid-cols-3 lg:gap-16'>
              {!posts.length && (
                <p className='text-2xl font-bold text-center z-100 col-span-full'>
                  No posts found (yet)
                </p>
              )}
              {posts &&
